  ...
  return (
    <main className="px-4 pb-24 pt-28 sm:px-6 sm:pt-36">
      <section className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
        ...
        <TiltPortrait><div className="relative overflow-hidden rounded-[2.35rem] border border-border/80 bg-card/60 p-3 shadow-2xl shadow-primary/5 backdrop-blur-sm"><div className="relative aspect-[4/5] overflow-hidden rounded-[1.9rem] bg-black"><img src="/pablo-rain-portrait.png" alt={copy.portraitLabel} className="h-full w-full object-cover grayscale contrast-110" /><div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent opacity-80" /><div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4"><div><p className="font-mono text-sm text-foreground">{copy.portraitLabel}</p><p className="font-mono text-[10px] uppercase tracking-widest text-primary">{copy.portraitMeta}</p></div><span className="rounded-full border border-primary/40 bg-background/70 px-3 py-1 font-mono text-[9px] uppercase tracking-widest text-primary">{copy.status}</span></div></div></div></TiltPortrait>
      </section>
