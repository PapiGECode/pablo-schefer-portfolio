      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 sm:mb-14 space-y-3 animate-fade-in-up">
          <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
            {language === "es" ? "Trabajo en curso · Desarrollo" : "Work in Progress · Development"}
          </p>
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">{language === "es" ? "Mesa de desarrollo" : "Development workbench"}</h2>
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            Repositorios activos, prototipos y herramientas que se construyen, prueban y mejoran.
          </p>
        </div>
