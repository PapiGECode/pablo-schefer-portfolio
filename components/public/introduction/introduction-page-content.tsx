  ...
  return (
    <main className="px-4 pb-24 pt-28 sm:px-6 sm:pt-36">
      <section className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
        <div className="space-y-8"><p className="font-mono text-[10px] uppercase tracking-[.32em] text-primary">{copy.eyebrow}</p><h1 className="max-w-3xl text-5xl font-semibold leading-[.96] tracking-[-.055em] text-balance sm:text-7xl">{copy.title} <span className="text-primary">{copy.accent}</span></h1><p className="max-w-xl text-base leading-7 text-muted-foreground sm:text-lg">{copy.lead}</p><div className="flex flex-wrap gap-3 pt-2"><Link href="https://github.com/PapiGECode" target="_blank" className="group inline-flex items-center gap-3 rounded border border-primary/60 bg-primary/10 px-4 py-3 font-mono text-xs uppercase tracking-wider text-primary transition-colors hover:bg-primary hover:text-primary-foreground">{copy.github}<ArrowUpRight className="size-4 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" /></Link><Link href="/projects" className="inline-flex items-center gap-3 rounded border border-border/70 px-4 py-3 font-mono text-xs uppercase tracking-wider text-muted-foreground transition-colors hover:border-primary/50 hover:text-foreground">{copy.projects}<ArrowUpRight className="size-4" /></Link></div></div>
        <TiltPortrait><div className="relative overflow-hidden rounded border border-border/80 bg-card/60 p-3 shadow-2xl shadow-primary/5 backdrop-blur-sm"><div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-black"><img src="/pablo-rain-portrait.png" alt={copy.portraitLabel} className="h-full w-full object-cover grayscale contrast-110 transition duration-700 hover:scale-[1.03]" /><div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent opacity-80" /><div className="pointer-events-none absolute inset-0 opacity-20 [background-image:linear-gradient(rgba(0,200,210,.35)_1px,transparent_1px)] [background-size:100%_5px]" /><div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4"><div><p className="font-mono text-sm text-foreground">{copy.portraitLabel}</p><p className="font-mono text-[10px] uppercase tracking-widest text-primary">{copy.portraitMeta}</p></div><span className="rounded-full border border-primary/40 bg-background/70 px-3 py-1 font-mono text-[9px] uppercase tracking-widest text-primary">{copy.status}</span></div></div></div></TiltPortrait>
      </section>
