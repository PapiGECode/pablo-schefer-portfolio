  ...
  return (
    <>
      <section className="page-hero page-hero--profile">
        ...
        <m.div className="profile-stats" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.65 }}>
      ...
      <section className="section profile profile--page" id="identidad">
        <m.div className="profile__visual" {...reveal}>
        ...
        <m.div className="profile__copy" {...reveal}>
