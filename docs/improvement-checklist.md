...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://pabloschefer.com/blog/${post.slug}`,
  ...
  return [
    {
      url: 'https://pabloschefer.com',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 1,
    },
    {
      url: 'https://pabloschefer.com/blog',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.9,
    },
...
<rss version="2.0">
  <channel>
    <title>PapiGECode Blog</title>
    <link>https://pabloschefer.com/blog</link>
    ...
    <item>
      ...
      <link>https://pabloschefer.com/blog/${post.slug}</link>
