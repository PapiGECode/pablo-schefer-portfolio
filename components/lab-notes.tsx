...
const notes = [
  {
    id: 1,
    title: "Moderación con contexto",
    excerpt: "Cómo combinar escucha, criterio y documentación para mantener comunidades sanas y activas.",
    date: "Ahora",
    category: "community",
  ...
  },
  {
    ...
    excerpt:
      "Convertir una necesidad real en una experiencia web útil con React, TypeScript y desarrollo asistido por IA.",
    date: "Ahora",
    category: "product",
  ...
  {
    id: 3,
    title: "Comunidades que construyen",
    excerpt: "Lo que he aprendido colaborando entre moderación, soporte y producto en proyectos digitales.",
    date: "2026",
  ...
  {
    id: 4,
    title: "De Discord al producto",
    excerpt: "Mi recorrido desde la moderación de comunidades hasta el desarrollo de herramientas digitales.",
    date: "2026",
    category: "profile",
