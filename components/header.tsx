...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/PapiGECode", icon: Github },
  { label: "x.com", href: "https://x.com/PapiGEGamer", icon: XLogo },
  { label: "Instagram", href: "https://www.instagram.com/papigegamer/", icon: Instagram },
]
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        <nav className="flex items-center justify-between">
          <Link href="/" className="group flex items-center gap-3">
            <div className="relative h-9 w-9 overflow-hidden rounded-lg border border-primary/50 bg-primary/10 transition-all duration-400 group-hover:border-primary group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-primary/25">
              <img
                src="/pablo-avatar.gif"
                alt="Pablo Schefer Orduña"
                className="h-full w-full object-cover"
              />
            </div>
            <span className="bg-gradient-to-l from-primary/50 to-accent bg-clip-text font-mono text-sm font-semibold tracking-tight text-transparent">
              ˡᵃˢᵗPapiGEGamer🐾ྀི
            </span>
          </Link>
